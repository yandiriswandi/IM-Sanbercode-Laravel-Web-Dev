...
<body>
    ...
    */
    ...
    {
        // Ubah huruf pertama menjadi kapital (opsional)
        $formattedName = ucfirst($name);
        echo "Halo $formattedName, Selamat Datang di Sanbercode!<br>";
    }
    ...
    */
    ...
    {
        $reversed = '';
        $length = strlen($string); // Ambil panjang string
    
        // Loop dari karakter terakhir hingga pertama
