    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('game.update',$game->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" class="form-control" placeholder="Enter game name"  value="{{$game->name}}">
            </div>

            <div class="form-group">
                <label for="gameplay">Gameplay</label>
                <input type="text" name="gameplay" id="gameplay" class="form-control" placeholder="Enter gameplay type" value="{{$game->gameplay}}"
                    >
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="developer" id="developer" class="form-control"
                    placeholder="Enter developer name"  value="{{$game->developer}}">
            </div>
